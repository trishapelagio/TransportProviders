    ...
    <section id="slider-area">
        ...
        <%  // Capture the data sent from the form
            ...
            // Instantiate the class that will process the registration
                ...
                offer.date              = v_date;
                offer.confirmed_date    = v_confirmdate;
                offer.cancelled_date    = v_canceldate;
                offer.email_tp          = v_email_tp;
                offer.substituted_by    = v_substituted_by;
                offer.base_rate         = v_base_rate;
                offer.hour_rate         = v_hour_rate;

                offer.updateOffering();
